 ...
 *
 * Every function hits the FastAPI backend at VITE_API_BASE_URL. Response shapes
 * mirror ../../CONTRACT.md and live in ./types.
 */
export { api, USE_MOCK, ApiError, delay } from './client'
export { getSessionId, resetSessionId, setSessionId } from '@/lib/session'
