      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 py-8 space-y-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-[#3A2F1D]">
          <div className="space-y-1">
            ...
            <p className="text-sm text-[#E5DFC9]/70 max-w-xl">
        ...
        >
          <Card className="p-8 border-[#3A2F1D] bg-[#1A130D] relative overflow-hidden shadow-2xl">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-[#3A2F1D]">
              <div className="space-y-2">
                ...
                <h3 className="text-2xl font-extrabold text-[#E5DFC9]">{primaryEx.title}</h3>
                <p className="text-xs text-[#E5DFC9]/60 font-mono">{primaryEx.repo} · {primaryEx.linesOfCode} lines of code</p>
                <p className="text-xs text-[#E5DFC9]/80 max-w-2xl leading-relaxed pt-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6 text-xs text-[#E5DFC9]/70">
              <div className="p-3.5 rounded-xl bg-[#000000] border border-[#3A2F1D]">
                <span className="font-semibold text-[#E5DFC9] block mb-1">Risk Profile:</span>
                <span>Contains timing attack and unparameterized SQL vulnerabilities.</span>
              </div>
              <div className="p-3.5 rounded-xl bg-[#000000] border border-[#3A2F1D]">
                <span className="font-semibold text-[#E5DFC9] block mb-1">Review Goal:</span>
                <span>Flag suspect line numbers and provide justification notes.</span>
              </div>
              <div className="p-3.5 rounded-xl bg-[#000000] border border-[#3A2F1D]">
                <span className="font-semibold text-[#E5DFC9] block mb-1">Evaluator:</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card
            hover
            onClick={() => navigate('/pro/xray')}
            className="p-6 border-[#3A2F1D] bg-[#1A130D] flex flex-col justify-between group cursor-pointer shadow-xl hover:border-[#E5DFC9]/35 hover:bg-[#3A2F1D]/40"
          >
            <div>
              <div className="w-10 h-10 rounded-xl bg-[#000000] border border-[#3A2F1D] text-[#E5DFC9] flex items-center justify-center mb-4">
                <Scan size={20} />
              </div>
              <h4 className="text-base font-bold text-[#E5DFC9] group-hover:text-[#E5DFC9] transition-colors mb-2">
                Code X-Ray
              </h4>
              <p className="text-xs text-[#E5DFC9]/60 leading-relaxed">
                Survey the architectural risk landscape across 6 vulnerability archetypes before line inspection.
              </p>
            </div>
            <div className="pt-4 mt-4 border-t border-[#3A2F1D] flex items-center justify-between text-2xs font-semibold text-[#E5DFC9]">
